...
<?php switch ( $cur ) {
	case 'general': ?>
		...
		<span class="extra-subnav">
            ...
            <a href="<?php echo $group_link; ?>/fields/" class="button hide"><?php _e( 'All Fields', 'buddypress-groups-extras' ); ?></a>
            <a href="<?php echo $group_link; ?>/pages/" class="button"><?php _e( 'All Pages', 'buddypress-groups-extras' ); ?></a>
            <a href="<?php echo $group_link; ?>/fields-manage/" class="button hide"><?php _e( 'Add Field', 'buddypress-groups-extras' ); ?></a>
