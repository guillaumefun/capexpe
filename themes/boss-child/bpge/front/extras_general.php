<p class="hide">
	<label for="group_extras_display_name"><?php _e( 'Please specify the page name, where all fields will be displayed', 'buddypress-groups-extras' ); ?></label>
...
<p>
	<label for="group_extras_display_name"><?php _e( 'Please specify the page name, where all custom pages will be displayed', 'buddypress-groups-extras' ); ?></label>
